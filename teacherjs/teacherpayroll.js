      ...
      AllRecords.forEach(function(CurrentRecord)
        {
          ...
          firebase.database().ref('Teachers Payroll').child(teacherid).orderByChild('monthdate').once('value', function(AllRecords)
            {
                AllRecords.forEach(function(CurrentRecord)
                {
